...
<head>
    <meta charset="utf-8">
    <title>协同办公系统</title>
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/office/css/office.css">

    <script src="<%=request.getContextPath()%>/resources/jquery-3.2.1.js"></script>
    <!--<script src="layui/layui.js" charset="utf-8"></script>-->
    <script src="<%=request.getContextPath()%>/resources/office/js/office.js"></script>
...
<div class="header">
    ...
    <div class="userinfo">
        ...
        <div class="userimg">
            <img src="<%=request.getContextPath()%>/resources/office/image/hujihua.jpg" alt="" class="usericon"/>
        </div>
    </div>
    <!-- 退出 -->
    <div class="logout">
        <a href="javascript:;" onclick="history.go(-1);"><img src="<%=request.getContextPath()%>/resources/office/image/logout.png" alt="" class="logoutimg"></a>
    </div>
...
<div class="main">
    <div class="menu">
        ...
        %>
        <div class="menu1">
            <a href="../views/office/office_home.jsp" target="open_page" class="zlgl"><i></i><span><%=module.getFmName()%></span></a>
        </div>
        <div class="menu2">
            <%
    ...
    <div class="right">
        <iframe name="open_page" src="../views/office/office_home.jsp" frameborder="0" width="100%" height="100%">
