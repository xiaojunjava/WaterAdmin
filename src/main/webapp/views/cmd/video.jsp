...
<div class="header">
    ...
    <div class="nav">
        <a href="<%=request.getContextPath()%>/main/jump.cmd">首页</a><div>|</div><a href="<%=request.getContextPath()%>/main/jump.video" class="underline">视频监控</a><div>|</div><a href="<%=request.getContextPath()%>/main/jump.guiji">历史轨迹</a><div>|</div><a href="<%=request.getContextPath()%>/main/jump.route">线路预设</a>
    </div>
  </div>
<div class="main">
  <table>
