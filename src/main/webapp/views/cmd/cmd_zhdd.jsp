...
<body onload=" onLoad();">
  <div class="header">
    ...
    <div class="userinfo">
      ...
      <div class="nav">
          <a href="<%=request.getContextPath()%>/main/jump.cmd">首页</a><div>|</div><a href="<%=request.getContextPath()%>/main/jump.cmd.zhdd" class="underline">指挥调度</a><div>|</div><a href="<%=request.getContextPath()%>/main/jump.cmd.csjg">采沙监管</a><div>|</div><a href="<%=request.getContextPath()%>/main/jump.cmd.jkgl">监控管理</a>
      </div>
  </div>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/cmd/js/cmd_zhdd.js"></script>
</html>
