    ...
    <script type="text/javascript">
        ...
        function loadTable(queryData) {
            ...
            var columns = [[
                ...
                {field: 'opt', title: '操作', width: 200, align: 'center',formatter:function(value,row,index){
                    var tmpOptStr = "<div style='display:inline; float:right'>"
                        +"<a href='javascript:;' class='easyui-linkbutton' onclick='finishCase()' style='width:80px'>结束案件</a>&nbsp;&nbsp;"
                        +"<a href='javascript:;' class='easyui-linkbutton' onclick='punish("+row.ciId+","+row.prId+")' style='width:80px'>处罚</a>&nbsp;&nbsp;"
        ...
        //--行政处罚决定书
        function punish(ciId, prId) {
            this.ciId = ciId;
            this.prId = prId;


            //alert('打开用户选择页面，选择取证人员');
            $("#xzcfjdsModule").panel({title: "&nbsp;行政处罚决定书"});
            $('#xzcfjdsModule').window('open');
        }
...
<!-- 行政处罚决定书 -->
<div id="xzcfjdsModule" class="easyui-window" data-options="modal:true,closed:true,iconCls:'icon-save'"
     style="width:800px;height:650px;padding:0px;">

    <div id="xzcfjdsSubModule" title="行政处罚告知书" style="padding:10px">
        <!-- 行政处罚告知书 -->
        <img src="../resources/handingcase/tmpImg/xzcfjds.png">
    </div>

    <br/>
    <div style="text-align:center;">
        <a href="javascript:void(0)" class="easyui-linkbutton" onclick="xzcfjds_ok()" style="width:80px">确定</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" onclick="xzcfjds_cancel()" style="width:80px">取消</a>
    </div>
    <br/>
</div>
...
<script>
    ...
    //--行政处罚决定书-确定
    function xzcfjds_ok(){
        $('#xzcfjdsModule').window('close');
    }

    //--行政处罚决定书-取消
    function xzcfjds_cancel(){
        $('#xzcfjdsModule').window('close');
    }
