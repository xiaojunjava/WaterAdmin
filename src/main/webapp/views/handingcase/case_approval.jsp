    ...
    <script type="text/javascript">
        ...
        function loadTable(queryData) {
            ...
            var columns = [[
                ...
                {field: 'ciPlace', title: '案件地点', width: 100, align: 'center'},
                ...
                {field: 'opt', title: '操作', width: 60, align: 'center',formatter:function(value,row,index){
                    var tmpOptStr = "<div style='display:inline; float:right'>"
                        +"<a href='javascript:;' class='easyui-linkbutton' onclick='viewEvidence("+row.ciId+","+row.prId+")' style='width:80px'>审查</a>&nbsp;&nbsp;"
                        +"</div>";
        ...
        function viewEvidence(ciId, prId) {
            ...
            $("#caseApprovalModule").panel({title: "&nbsp;案件审查"});
            $('#caseApprovalModule').window('open').window('resize',{top: '10px'});
...
<!--案件审查-->
<div id="caseApprovalModule" class="easyui-window" data-options="modal:true,closed:true,iconCls:'icon-save'"
    ...
    <div style="text-align:center;">
        <a href="javascript:void(0)" class="easyui-linkbutton" onclick="caseTransfer()" style="width:80px">移送</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" onclick="RevokeCase()" style="width:80px">撤销立案</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" onclick="decideToPunish()" style="width:80px">决定处罚</a>
    </div>
</div>
...
<script>
    ...
    function caseTransfer(){
        $.messager.confirm('确认', '您确定要移送案件吗?', function (r) {
            if (r) {
                $('#caseApprovalModule').window('close');
                $.messager.alert('提示', '案件移送已成功！', 'warning');
            }
        })
    }
    ...
    //--决定处罚
    function decideToPunish(){
        $.messager.confirm('确认', '您确定要处罚吗?', function (r) {
            if (r) {
                $('#caseApprovalModule').window('close');
                $.messager.alert('提示', '决定处罚已成功！', 'warning');
            }
        })
    }
</script>
