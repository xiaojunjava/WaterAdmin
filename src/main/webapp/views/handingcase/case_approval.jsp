            ...
            var columns = [[
                ...
                {field: 'opt', title: '操作', width: 180, align: 'center',formatter:function(value,row,index){
                    var tmpOptStr = "<div style='display:inline; float:right'>"
                        +"<a href='javascript:;' class='easyui-linkbutton' onclick='approvalCaseAdopt("+row.ciId+","+row.prId+")' style='width:80px'>通过</a>&nbsp;&nbsp;"
                        +"<a href='javascript:;' class='easyui-linkbutton' onclick='approvalCaseRefuse("+row.ciId+","+row.prId+")' style='width:80px'>驳回</a>&nbsp;&nbsp;"
