...
<head>
    <meta charset="utf-8">
    <title>办案管理系统</title>
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/handingcase/css/anjian.css">

    <script src="<%=request.getContextPath()%>/resources/jquery-3.2.1.js"></script>
    <!--<script src="layui/layui.js" charset="utf-8"></script>-->
    <script src="<%=request.getContextPath()%>/resources/handingcase/js/anjian.js"></script>
...
<div class="main">
    <div class="menu">
        ...
        %>
        <div class="menu1">
            <a href="../views/handingcase/anjian_home.jsp" target="open_page" class="zlgl"><i></i><span><%=module.getFmName()%></span></a>
        </div>
        <div class="menu2">
            <%
